(function() {
  ...
  function unformattedModelValue(model) {
    return model.get(this.column.field);
  }

  function formattedModelValue(model) {
  ...
  var isInputValueChanged = function() {
    return (!(this.$input.val() == "" && this.defaultValue == null) &&
